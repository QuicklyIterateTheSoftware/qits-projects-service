...
class QitsOidcClientResourceOverridesOldExtrasTest {
  ...
  public static class BothSet implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      return Map.of(
          "QITS_RESOURCE_IDP_CLIENT_ID", "resource-qits-projects",
  ...
  void theResourceEnvWinsOverTheOldExtrasEnv() {
    assertEquals("resource-qits-projects", value("quarkus.oidc-client.qits.client-id"));
  ...
  void theContainersOwnerKeyFollowsTheResourceProvidedId() {
    assertEquals("resource-qits-projects", value("qits.projects.containers.owner"));
  }
}
