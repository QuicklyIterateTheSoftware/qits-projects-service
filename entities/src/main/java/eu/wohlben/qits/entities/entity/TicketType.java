...
/**
 * What kind of work a {@link Archetype#TICKET} entity is. Stored as the enum name (V4) in {@link
 * WorkEntity#ticketType}, behind a check constraint,
 ...
 * plan is an {@link Archetype#EPIC}, which is why there is no FEATURE here.
 */
